                ...
                <div class="row">
                    <div class="col-lg-6">                    
                        <div class="form-group">
                            <label>員工編號</label>
                            <input class="form-control" id="pno" type="text" placeholder="">
                        </div>
                        <div class="form-group">
                            <label>身分證字號</label>
                            <input class="form-control" id="idno" type="text" placeholder="" >
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>電話</label>
                            <input class="form-control" id="tel" type="text" placeholder="" >
                        </div>
                        <div class="form-group">
                            <label>職稱</label>
                            <input class="form-control" id="jobname" type="text" placeholder="" >
                        </div>
                        <div class="form-group">
                            <label>離職日</label>
                             <input class="form-control datepicker" id="outday" type="text" placeholder="" >
                        </div>                           
                    </div>
                    <!-- /.col-lg-6 (nested) -->
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label>姓名</label>
                            <input class="form-control" id="cname" type="text" placeholder="" >
                        </div>
                        <div class="form-group">
                            <label>出生日期</label>
                            <input class="form-control datepicker" id="birsday" type="text" placeholder="" >
                        </div>
                        <div class="form-group">
                            <label>地址</label>
                        ...
                        <div class="form-group">
                            <label>單位</label>
                            <input class="form-control" id="depname" type="text" placeholder="" >
                        </div>
                        <div class="form-group">
                            <label>到職日</label>
                        <input class="form-control datepicker" id="inday" type="text" placeholder="" >
                        </div>                         
                    </div>
                    <!-- /.col-lg-6 (nested) -->
                </div>
...
<script>
  $('#btn_confirm').click(function() {
		...
		$.ajax({
        	url: "{{ url('/backstage/manager/create') }}", // point to server-side PHP script 
