                    ...
                    @foreach ($info as $infolist) 
                        <tr class="odd gradeX"> 
                            ...
                            <td >
                                ...
                                <a href="" class="btn btn-sm btn-primary width-60 m-r-2"><i class="fa fa-edit "></i> 修改</a>
                                <a href="" class="btn btn-sm btn-danger width-60 m-r-2"><i class="fa fa-pencil "></i> 刪除</a>
                            </td>
                        </tr>
                    @endforeach                                    
                    </tbody>
